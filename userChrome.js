...
(function(){
  ...
  var arrSubdir = new Array("", "xul","withTabMixPlus"  ,  "userCrome.js.0.8","userContent","SubScript", "UCJSFiles","TabMixPlus","PageBrowse","userMenu","userButton","ToolbarScript","downloadPlus","AAA");
//スクリプトはこの順番で実行される
  //===================================================================
