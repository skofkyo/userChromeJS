...
(function() {
	window.anobtn = {
		...
		reload: function(isAlert) {
			...
			//this.makebtn();
			$("PanelUI-menu-button").appendChild(this.makepopup());
			$("PanelUI-menu-button").addEventListener("contextmenu", function(event) {
			  document.getElementById("anobtn_popup").openPopupAtScreen(event.screenX, event.screenY, true); 
		...
		unint: function(real) {
			...
			$("PanelUI-menu-button").removeChild($("anobtn_popup"));
