    ...
    var anoBtn = {
        ...
        PopupShowing: function(event) {
            ...
            for (let j = 0, lenj = userChrome_js.arrSubdir.length; j < lenj; j++) {
                ...
                var mp = menu.appendChild($C('menupopup'));
                ...
                for (let i = 0, len = scripts.length; i < len; i++) {
                    ...
                    flg = type;
                    var mi = mp.appendChild($C('menuitem'));
        ...
        CreateMenuitem: function(obj, i) {
            ...
            if (obj.id && (menuitem = $(obj.id))) {
                ...
                for (let [key, val] in Iterator(obj)) {
                    ...
                    if (key != 'clone') dupMenuitem.setAttribute(key, val);
                }
...
#anoBtn_Popup menu:not(#uc_quickProxy_menu) menupopup menuitem[checked="false"]:not(#redirector-toggle):not(.gm-enabled-item):not(#uc_SmartScrollbar) {\
