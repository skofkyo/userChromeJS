...
keys[2] = "gBrowser.selectedTab = gBrowser.addTab('https://translate.google.cn/#auto/zh-CN/');";
keys[3] = "gBrowser.selectedTab = gBrowser.addTab('http://bbs.kafan.cn/forum-215-1.html');";
keys[4] = "gBrowser.selectedTab = gBrowser.addTab('http://sunbox.cc/');";
keys[5] = function(){var newtabs=["http://www.pconline.com.cn/","http://bbs.kafan.cn/forum-215-1.html","http://www.163.com/","http://www.ithome.com/list/","http://sunbox.cc/"];var i=0;while(i<=newtabs.length-1){gBrowser.selectedTab=gBrowser.addTab(newtabs[i]);i=i+1;}};//一键打开标签组
...
keys['e'] = function(ev) {ReaderParent.toggleReaderMode(event);};//开启火狐自带阅读模式
...
keys['q'] = "BrowserSearch.webSearch();"; //聚焦到搜索栏
keys['w'] = "openLocation();"; //聚焦到地址栏
