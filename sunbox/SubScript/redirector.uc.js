...
(function() {
	...
	function RedirectorUI() {
		...
		this.enableIcon = "data:image/png;base64,";
		this.disableIcon = "data:image/png;base64,";
	}
			...
			if (this.addIcon && !document.getElementById("redirector-icon")) {
				...
				let xml = '\
					<menupopup id="redirector-menupopup" onclick="event.preventDefault(); event.stopPropagation();">\
						...
						<menuitem label="重载规则" image="data:image/png;base64," class="menuitem-iconic" id="redirector-reload" oncommand="Redirector.reload();"/>\
