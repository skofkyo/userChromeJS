...
var FullZoomConfig = new function () {
  ...
  this.zoomValues = "0.3,0.5,0.67,0.8,0.9,1,1.1,1.2,1.25,1.33,1.5,1.7,2,2.4,3";
  //label
...
//ui
function fullZoomUI() {
  var statusbar = document.getElementById("urlbar"); //status-bar navigator-toolbox urlbar-icons  TabsToolbar
