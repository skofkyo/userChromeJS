...
(function(){
    ...
    var Sites = [
        ...
            css: "body{width:330px;overflow:hidden;}.m-top,.m-demofm h2{display:none!important}.m-demofm{margin-left:-330px!important;margin-right:-330px!important;margin-top:-70px!important;margin-bottom:-280px!important;}",
            control: {
        ...
        },
        {
            ...
            css: "body{width:360px;overflow:hidden;}.player-large,.cover.rounded.PLCover{position:fixed;top:20px;left:0;width:300px;height:300px;}#playerCt{position:fixed;top:-5px;left:0;width:300px;height:300px;z-index:999;background: black !important;opacity: 0.5 !important;}#lyricWrapper{position:fixed;top:15px;left:0;width:300px;height:300px;z-index:999;background: black !important;opacity: 0.8 !important;}.vol-tags{position:fixed;left:0px;top:0px;width: 300px;}.pagenav-wrapper{position:fixed;left:1px;top:-5px;z-index:998;width: 285px !important;text-align:center;text-indent: -0.8em;background: black !important;opacity: 0.8 !important;}.item.actived{position:fixed;left:115px;top:73px;width:63px;height:22px;z-index:999;text-align:center;background: black !important;opacity: 0.8 !important;}#luooPlayerPlaylist > UL{overflow-y:scroll;overflow-x:hidden;position:fixed;top: 323px !important;width:300px;height:200px;}.article{ position:fixed;overflow-x:hidden;left:0px;top:0px;width: 300px;height:525px;}.cover.rounded{overflow-x:hidden; width: 300px;height: 200px;}.header,.vol-name,.vol-cover,#widgetHotVol,.vol-desc,.relative-vol,#comment,.footer,.vol-meta,.thanks-block{display:none;}",
            control: {
