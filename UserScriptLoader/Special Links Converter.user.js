...
/* @reason
1、完美破解狗狗专用链接
2、使用浏览器原生函数解码，提升运行效率并减少90%代码
3、增加去除论坛附件下载等待时间功能，立即下载
4、在chrome下可使用扩展 TamperMonkey 安装该脚本，随后将推出chrome扩展版
5、增加捐赠等多个功能的开关模块，使用方法：
   点击 GreaseMonkey 的图标 > 用户脚本命令 > [首选项]专用链破解
@end*/
// ==/UserScript==
