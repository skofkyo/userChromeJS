...
// @match *://manga.madokami.com/reader/*
...
// @match *://www.3asq.info/*/*
// @match *://readcomiconline.com/Comic/*
// -- FOOLSLIDE START
...
var implementations = [{
  ...
  name: 'manga-cow, manga-doom, manga-indo, 3asq.info',
  match: "^https?://(mngcow|mangadoom|mangaindo|www\\.3asq)\\.(co|id|info)/[^/]+/[0-9.]+",
  img: '.prw a > img',
  next: '.prw a[onclick]',
  ...
  name: 'madokami',
  match: "^https?://manga.madokami.com/reader/.+",
  img: 'img',
  next: 'img',
  curpage: function() {
