...
// @include        http://www.ankty.com/*
// @include        http://www.33lc.com/*
// @include        http://bbs.wmzhe.com/*
// @include        http://splayer.org/*
// @include        http://board.mozest.com/*
// @include        http://my219.cn/*
// @include        http://g.mozest.com/*
// @include        http://www.pccppc.com/*
// @include        http://www.firefox.net.cn/*
...
function doADoc(curDoc) {
	try {		
		tranXpathText(curDoc);
		//tranXpathTextarea(curDoc);
		//tranXpathInput(curDoc);
	} catch(ex) {
		alert("doADoc " + ex + curDoc + " name: " + curDoc.nodeName);
	}
}

function doFrames(curDoc, deep) {
	var FRAMEDEEP = 18;
	...
	try {	
		...
		function addFrameCollection(curDoc, deep){		
			...
			if ((my_frames_len > 0) && (deep < FRAMEDEEP)) {
			...
			if ((iFrames_len > 0) && (deep < FRAMEDEEP)) {				
