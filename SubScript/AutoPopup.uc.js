...
(function () {
      ...
      stylishBtn.setAttribute("popup", "");//¨ú®ø­ìƒSªº¤U©Ôµæ„Ë
...
(function() {
            ...
            GMBtn.removeAttribute("command");//¨ú®ø«ö…r¥\¯à(…ÑˆÕ­PautoPopupÆÓªk¦Ûƒð‡É¥X¤U©Ôµæ„Ë)
            GMBtn.removeAttribute("oncommand");//¨ú®ø­ìƒS«ö…r(©_¸´ªºGM©~µMŠx°µƒU¹M¡A¤W­±„±¦æ¬Oƒo¤F¤Á„ã†¶‡á¡H)
  
            GMBtn.setAttribute("type", "menu");//«ö…r+¥kŠ~µæ„Ë
            GMBtn.setAttribute("onclick", "GM_util.setEnabled(!GM_util.getEnabled());GMsetIconStatus(event);");//GMsetStatusDirectly(event);
