...
// @note            顯示網站IP地址和所在國家國旗，幫助識別網站真實性。
// @note            左鍵點擊圖標復制信息，中間刷新信息，右鍵彈出菜單。
// @note            修改瀏覽器標識，破解反盜鏈，更多功能需要【_showFlagS.js】配置文件。
...
// @version         1.6.2.0		2014.08.29 21:30	完善卸載，完善路徑兼容。
// @version         1.6.1.2		2014.08.27 20:30	完善禁用和路徑支持。
// @version         1.6.1.1		2014.08.24 22:00	錯誤頁面顯示。
// @version         1.6.1.0		2014.08.22 22:00	修復Linux和Windows路徑問題。
...
// @version         1.5.8.3.4 	將存入perfs的選項移至腳本內，便於配置文件的理解,其他修復。
// @version         1.5.8.3.3 	修復因臨時刪除文件導致的錯誤。
// @version         1.5.8.3.2 	identity-box時錯誤頁面智能隱藏，已查詢到便顯示，每查詢到便隱藏。
// @version         1.5.8.3.1 	配置文件增加圖標高度設置，identity-box時錯誤頁面自動隱藏。
// @version         1.5.8.3 	修復圖標切換錯誤的問題。
// @version         1.5.8.2 	修復FlagFox圖標下，找不到圖標就消失的問題，其他修改。
// @version         1.5.8.1 	配置文件加入一個圖標大小的參數。
// @version         1.5.8 		修復菜單重復創建的BUG，查詢源外置;可以丟棄舊版lib（不推薦）。
// @version         1.5.7		修改菜單和圖標的創建方式，避免各種不顯示，不彈出問題。
// @version         1.5.6 		將腳本設置也移到配置文件中，配置文件可以設置TIP顯示條目，改變數據庫文件等。
// @version         1.5.5 		增加flagfox擴展國旗圖標庫，相對路徑profile\chrome\lib\isLocalFlags下，直接存放圖標,支持實時切換。
// @version         1.5 		增體加右鍵菜單外部配置，配置方式和anoBtn一樣，具請參考配置文件。
// @version         1.4 		增加幾個詳細信息；服務器沒給出的就不顯示。
// @version         1.3 		增加淘寶查詢源，修復不顯示圖標，刷新、切換查詢源時可能出現的圖標提示消失等BUG
// @version         1.2.1 		修復identity-box時page-proxy-favicon的問題
// @version         1.2 		位置為identity-box時自動隱藏page-proxy-favicon，https顯示
// @version         1.1 		設置延遲，增加本地文件圖標。
// ==/UserScript==

/**
 * 參考 Show Location 擴展、Flagfox 擴展、http://files.cnblogs.com/ziyunfei/showFlag.uc.js
 */
location == "chrome://browser/content/browser.xul" && (function(CSS) {
    ...
    var showFlagS = {
        ...
        showFlagHash: [],
        showFlagTooltipHash: [],
        DlibIconPath: "local\\countryflags.js",
        DLocalFlags: "local\\LocalFlags\\",
        ...
        makePanel: function() {
            ...
            /*let xml = '\
				<menupopup id="showFlagS-popup">\
					<menuitem label="復制信息" id="showFlagS-copy" oncommand="showFlagS.command(\'Copy\');" />\
					...
					<menuitem label="腳本設置" id="showFlagS-set-Pref" onclick="showFlagS.openPref(\'Set\');" class="showFlagS menuitem-iconic" image="data:image/png;base64,"/>\
            ...
            let xul = '<?xml version="1.0"?><?xml-stylesheet href="chrome://global/skin/" type="text/css"?>\
				<prefwindow xmlns="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul"\
					...
					<prefpane id="main" flex="1">\
									...
									<groupbox>\
										<caption label="功能開關(需要配置文件支持)" />\
											<grid>\
												...
												<rows>\
													<row align="center">\
														<checkbox id="RefChanger" label="破解(圖片)反盜鏈" preference="RefChanger" />\
													</row>\
													<row align="center">\
														<checkbox id="UAChanger" label="自定義修改瀏覽器標識UserAgent" preference="UAChanger" />\
													</row>\
													<row align="center">\
														<checkbox id="SeoInfo" label="查詢網站SEO信息(普通用戶不推薦)" preference="SeoInfo" />\
													</row>\
													<row align="center">\
														<checkbox id="Reacquire" label="失敗之後自動重獲取(不推薦,可能影響效率)" preference="Reacquire" />\
													</row>\
													<row align="center">\
														<checkbox id="MyInfo" label="查詢本機IP信息(不推薦,使用查詢源截取更節能)" preference="MyInfo" />\
													</row>\
												</rows>\
											</grid>\
									</groupbox>\
										...
										<caption label="一般設置" />\
											<grid>\
												...
												<rows>\
													<row align="center">\
														<label value="查詢延時："/>\
														<textbox id="Inquiry_Delay" type="number" preference="Inquiry_Delay" tooltiptext="毫秒,延遲時間，時間內未取得所選擇查詢源數據，就使用備用詢源,預設3500毫秒。"/>\
													</row>\
													<row align="center">\
														<label value="圖標的位置：" />\
														<menulist preference="Icon_Pos" id="Icon_Pos">\
															<menupopup id="Icon_Pos_Popup">\
																<menuitem label="地址欄左邊" value="0"/>\
																<menuitem label="地址欄圖標" value="1"/>\
																<menuitem label="可移動按鈕" value="2"/>\
															</menupopup>\
														</menulist>\
													</row>\
													<row align="center">\
								...
								<caption label="圖標庫設置" />\
									<grid>\
										...
										<rows>\
											...
											<row align="center">\
												<label value="Lib國旗圖標庫(支持相對路徑，相對於 Chrome 目錄）："/>\
											</row>\
											<row>\
												<textbox id="libIconPath" preference="libIconPath" tooltiptext="如: countryflags.js、lib\\countryflags.js"/>\
												<button label="瀏覽" oncommand="opener.showFlagS.option_Scripts.ChouseFile(true);"/>\
											</row>\
											<row align="center">\
												<label value="本地PNG圖標文件夾(支持相對路徑，相對於 Chrome 目錄）："/>\
											</row>\
											<row>\
												<textbox id="LocalFlags" preference="LocalFlags" tooltiptext="如:（空白）、lib\\LocalFlags"/>\
												<button label="瀏覽" oncommand="opener.showFlagS.option_Scripts.ChouseFile();"/>\
											</row>\
										</rows>\
									</grid>\
							</groupbox>\
						...
						<hbox flex="1">\
							<button dlgtype="extra1" label="還原默認值" />\
							<button dlgtype="extra2" label="編輯菜單配置" />\
							<spacer flex="1" />\
        ...
        setPerfs: function(type, val) {
            if (type == "UA") {
                ...
                var label = "瀏覽器標識(UserAgent)已切換至 [" + this.UAList[val].label + "]";
        ...
        onLocationChange: function(forceRefresh) {
            ...
            try {
                ...
                if (aLocation && /data/.test(aLocation.scheme)) {
                    ...
                    this.icon.tooltipText = 'Base64編碼文件';
                    return;
                }
        ...
        lookup: function(ip, host) {
            ...
            if (ip == "0" || /^(about:neterror)/.test(url)) {
                ...
                if (url) {
                    obj.SiteInfo = '錯誤類型：' + url.substring(url.indexOf("=") + 1, url.indexOf("&")) + '\n' + '詳細描述：' + decodeURI(url.substring(url.lastIndexOf("=") + 1));
                } else {
                    obj.SiteInfo = '頁面載入錯誤';
                }
        ...
        lookup_Local: function(type, host, ip) {
            ...
            if (type == "IP") {
                if (/^192.168.|169.254./.test(ip)) {
                    src = this.LAN_Flag;
                    obj.SiteInfo = '本地局域網服務器';
                } else {
                    obj.SiteInfo = '回送地址：本機[服務器]';
                }
                this.showFlagTooltipHash[host] = obj;
        ...
        lookupIP_taobao: function(ip, host, callback, other) {
            ...
            var onerror = function() {
                ...
                if (callback) callback(null, null, '無法獲取國家代碼，請刷新！');
            };
            req.onerror = onerror;
            req.timeout = self.Inquiry_Delay;
            req.ontimeout = onerror;
