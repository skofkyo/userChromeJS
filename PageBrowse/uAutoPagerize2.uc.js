...
(function(css) {
    ...
    var Config = {
        ...
        PRELOADER_NEXTPAGE: false, // 提前預讀下一頁..就是翻完第1頁,立馬預讀第2頁,翻完第2頁,立馬預讀第3頁..(大幅加快翻頁快感-_-!!)
        ...
        launch: function(win, timer, DOMLoad) {
            ...
            if (typeof win.AutoPagerize == 'undefined') {
                ...
                win.AutoPagerize = {
                        ...
                        addDocumentFilter: function(f) {
                            win.documentFilters.push(f);
                        },
                        addResponseFilter: function(f) {
                            win.responseFilters.push(f);
                        },
                        addRequestFilter: function(f) {
                            win.requestFilters.push(f);
                        },
                        launchAutoPager: function(l) {
                            launchAutoPager_org(l, win);
                        }
                    }
            ...
            win.fragmentFilters.push(function(df) {
                ...
                arr.forEach(function(elem) {
                    ...
                    if (elem.getAttribute('onclick') == 'atarget(this)') { // 卡飯論壇的控制是否在新標籤頁打開
            ...
            win.setTimeout(function() {
                ...
                win.ap = null;
                miscellaneous.forEach(function(func) {
                    func(doc, locationHref);
                });
                var index = -1;
    ...
    AutoPager.prototype = {
        ...
        addPage: function(htmlDoc, page, nextPageUrl) {
            ...
            if (!this.isFrame) {
                ...
                o.style.cssText = [
                    'background: ', COLOR['enable'], ';', 'width: .8em;', 'height: .8em;', 'padding: 0px;', 'margin: 0px .4em 0px 0px;', 'display: inline-block;', 'vertical-align: middle;'
                ].join('');
        ...
        initIcon: function() {
            ...
            div.style.cssText = [
                'font-size: 12px;', 'position: fixed;', 'z-index: 9999;', 'top: 3px;', 'right: 3px;', 'width: 10px;', 'height: 10px;', 'border: 1px inset #999;', 'padding: 0px;', 'margin: 0px;', 'color: #fff;', 'background: ' + COLOR[this.state]
            ].join(" ");
    ...
    function launchAutoPager_org(list, win) {
        ...
        list.some(function(info, index, array) {
            try {
                ...
                if (win.ap) {} else if (!exp.test(locationHref)) {} else if (!getElementMix(info.nextLink, doc)) {
