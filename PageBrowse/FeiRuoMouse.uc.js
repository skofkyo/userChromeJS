...
// @version         0.1.1   2016.03.04  14:00   修復手勢L>R，L<R軌跡不消失問題，添加窗口拖拽功能。
// @version         0.1.0   2016.02.23  17:00   修復手勢軌跡問題，完善拖拽，向上支持,修正編輯。
// @version         0.0.9   2015.06.20  15:00   修改機制，需要從新編輯配置文件。
// @version         0.0.8   2015.06.10  15:00   修復切換標簽時軌跡不消失問題。
...
// @version         0.0.3   2015.05.18  15:00   修復拖拽，自定義手勢軌跡。
	...
	var FeiRuoMouse = {
		...
		loadCustomCommand: function(isAlert) {
			...
			try {
				...
				var ErrMsg = e + "請重新檢查配置文件第 " + line + " 行！";
				log(ErrMsg);
		...
		ProgressGesture: function(event) {
			...
			if (this.GesTrailEnabel) {
				...
				if (that.xdTrailAreaContext) {
					that.xdTrailAreaContext.strokeStyle = this.trailColor; //顏色
					that.xdTrailAreaContext.lineJoin = "round";
					that.xdTrailAreaContext.lineWidth = this.trailSize; //粗細
			...
			if (direction != dChain.charAt(dChain.length - 1)) {
				...
				//if (that.directionChain.length <=4) {} else {}限制手勢轉折次數
			}
		...
		Listen_AidtKey: function(event, dChain, type) {
			...
			if (obj.Enable != "1")
				return this.ActionStaus(event, dChain, obj.label + "(未啟用)");
		...
		ActionStaus: function(event, dChain, str) {
			...
			type = type ? (type.cn + "拖拽：") : "手勢：";
			EventKey = EventKey ? (EventKey + "+") : "";
			status(type + EventKey + dChain + (str ? str : "(未定義)"));
		},
		...
		get OptionWin() {
			var xul = '<?xml version="1.0"?><?xml-stylesheet href="chrome://global/skin/" type="text/css"?>\
                    ...
                    <prefpane id="main" flex="1">\
                            ...
                            <tabpanels flex="1">\
                                    ...
                                    <groupbox>\
                                        <caption label="功能"/>\
                                            <grid>\
                                                <rows>\
                                                    <row align="center">\
                                                        <checkbox id="EnableDragr" label="拖拽手勢" preference="EnableDrag" oncommand="Change();"/>\
                                                        <checkbox id="EnableGesr" label="滑鼠手勢" preference="EnableGes" oncommand="Change();"/>\
                                                        <checkbox id="EnableMover" label="視窗拖拽" preference="EnableMove" oncommand="Change();"/>\
                                                ...
                                                <rows>\
                                                    <row align="center" id="MoveWinSet">\
                                                        ...
                                                        <radiogroup id="MoveBtn" preference="MoveBtn">\
                                                            <hbox>\
                                                                <radio label="左鍵" id="MoveBtn_0" value="0"/>\
                                                                <radio label="中鍵" id="MoveBtn_1" value="1"/>\
                                                                <radio label="右鍵" id="MoveBtn_2" value="2"/>\
                                                            </hbox>\
                                                        </radiogroup>\
                                                    </row>\
                                                </rows>\
                                    ...
                                    <groupbox>\
                                        <caption label="滑鼠手勢"/>\
                                            <grid>\
                                                <rows>\
                                                    <row align="center">\
                                                        <checkbox id="GesTrailEnabelr" label="顯示軌跡" preference="GesTrailEnabel" oncommand="Change();"/>\
                                                    </row>\
                                                    <row align="center">\
                                                        <label value="軌跡尺寸："/>\
                                                        <textbox id="trailSize" type="number" preference="trailSize" style="width:180px" tooltiptext="單位：像素(px)"/>\
                                                    </row>\
                                                    <row align="center">\
                                                        <label value="軌跡顏色："/>\
                                                    ...
                                                    <row align="center">\
                                                        <checkbox id="isStatusr" label="顯示狀態提示" preference="isStatus" oncommand="Change();"/>\
                                                    </row>\
                                                    <row align="center">\
                                                        <label value="狀態提示時間："/>\
                                                        <textbox id="StatusTime" type="number" preference="StatusTime" tooltiptext="單位：毫秒"/>\
                                                    </row>\
                                                    <row align="center">\
                                                        <label value="滑鼠手勢觸發按鍵："/>\
                                                        <radiogroup id="GesIngBtn" preference="GesIngBtn">\
                                                            <hbox>\
                                                                <radio label="左鍵" id="GesBtn_0" value="0"/>\
                                                                <radio label="中鍵" id="GesBtn_1" value="1"/>\
                                                                <radio label="右鍵" id="GesBtn_2" value="2"/>\
                                                            </hbox>\
                                                        </radiogroup>\
                                                    </row>\
                                                </rows>\
                                ...
                                <tabpanel orient="vertical" flex="1" style="width:500px">\
                                    <vbox>\
                                        <hbox id="listarea" flex="1">\
                                            <tree id="ruleTree" seltype="single" flex="1" enableColumnDrag="true" class="tree" rows="15"\
                                                ...
                                                <treecols>\
                                                    ...
                                                    <treecol id="Type-col2" label="動作" flex="1" persist="width hidden ordinal"/>\
                                                    <splitter class="tree-splitter"/>\
                                                    <treecol id="Action-col2" label="目標" flex="1" persist="width hidden ordinal"/>\
                                                    <splitter class="tree-splitter"/>\
                                                    <treecol id="Keys-col2" label="鍵盤" flex="1" persist="width hidden ordinal" hidden="true"/>\
                                                    <splitter class="tree-splitter"/>\
                                                    <treecol id="TKeys-col2" label="輔助" flex="1" persist="width hidden ordinal" hidden="true"/>\
                                                    <splitter class="tree-splitter"/>\
                                                    <treecol id="Enable-col2" label="啟用" flex="1" type="checkbox" persist="width hidden ordinal"/>\
                                                </treecols>\
                                        ...
                                        <hbox>\
                                            <spacer flex="1"/>\
                                            <button label="新增" id="newButton" oncommand="opener.FeiRuoMouse.OptionScript.onNewButtonClick();"/>\
                        ...
                        <hbox flex="1">\
                            <button dlgtype="extra1" label="還原預設值"/>\
                            <button dlgtype="extra2" label="自定義命令"/>\
                            <spacer flex="1" />\
                            <button label="套用" oncommand="opener.FeiRuoMouse.OptionScript.Save();"/>\
			...
			var xul = '<?xml version="1.0"?><?xml-stylesheet href="chrome://global/skin/" type="text/css"?>\
                    ...
                    windowtype="FeiRuoMouse:DetailWindow">\
                        ...
                        <script>\
                            ...
                            <vbox style = "width:400px; min-height:275px;">\
                                <groupbox>\
                                    <radiogroup id="MType">\
                                        <rows>\
                                            <row align="center">\
                                                <radio label="滑鼠手勢" id="Ges" value="Ges" oncommand="opener.FeiRuoMouse.DetaillScript.MChanged();"/>\
                                            </row>\
                                            <row align="center">\
                                                ...
                                                <radiogroup id="DragType">\
                                                    <hbox>\
                                                        <radio label="圖片" id="Drag_Image" value="Image" oncommand="opener.FeiRuoMouse.DetaillScript.CreateCommandMenu();"/>\
                                                        <radio label="鏈結" id="Drag_Url" value="Url" oncommand="opener.FeiRuoMouse.DetaillScript.CreateCommandMenu();"/>\
                            ...
                            <hbox flex="1">\
                                <button dlgtype="extra1" label="重設" />\
                                <spacer flex="1" />\
                                <button dlgtype="accept"/>\
                                <button dlgtype="cancel"/>\
                            </hbox>\
	...
	FeiRuoMouse.OptionScript = {
		...
		setTreeitem: function(treeitem, params) {
			with(treeitem.firstChild) {
				...
				if (type != "")
					type = params["Type"] == "Image" ? "圖片" : (params["Type"] == "Url" ? "鏈結" : "文字");
				...
				childNodes[4].setAttribute("label", params["TKey"] == "1" ? "排除" : !params["Key"] ? "" : "輔助");
	...
	FeiRuoMouse.DetaillScript = {
		...
		Action_Label: function(isAlert) {
			if (!isAlert)
				...
				_$D("Action_Label").value = "W-(上滾輪),W+(下滾輪),L<R(右左),L>R(左右)";
		},
