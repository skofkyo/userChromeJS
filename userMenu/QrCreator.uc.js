			...
			if (event.button == 0) {
				if (gContextMenu) {
					if (gContextMenu.isTextSelected) {
						...
						altText = "QR碼內容[文本]";
						target_data = prompt("請輸入文本創建一個QR碼（長度不超過250字節）：", "");
					} else {
