...
// @note                   2016.8.17 改進函數的調用 增加視窗開啟方式
...
// @homepageURL    https://github.com/skofkyo/userChromeJS/blob/master/userMenu/EncodeDecodeHtml.uc.js
// ==/UserScript==
(function() {
    ...
    var EncodeDecodeHtml = {
        ...
        addmenuitem: function() {
            ...
            var menues = [{
                ...
                label: "JsCss混淆/格式化/壓縮",
                html: "JsCssBeautifyCompress",
                w: "1024",
                h: "600",
            ...
            for (i = 0; i < menues.length; i++) {
                ...
                if (menue.label == "sep") {
                    ...
                    item = $C('menuitem', {
                        ...
                        h: menue.h || "",
                        image: menue.image,
                        oncommand: menue.oncommand || "EncodeDecodeHtml.onCommand(event);",
                    });
                }
                mp.appendChild(item);
            }
