...
var updatebookmark = {
  ...
  onload: function() {
    ...
    menuItem.setAttribute("label", "更新為當前地址");
    ...
    menuItem.setAttribute("label", "在此書籤後面添加新書籤");
    ...
    if (newurlValue == "about:blank" || newurlValue == "about:home") {
      ...
      if (menubook4) menubook4.hidden = true;
        ...
        { menubook3.hidden = false;
          menubook3.setAttribute("label", "在此書籤後面添加新書籤");
        }
        ...
        if (menubook3) 
        { menubook3.hidden = false;
          menubook3.setAttribute("label", "在此文件夾添加新書籤");
        }
        if (menubook4) menubook4.hidden = true;
      }
    }
  ...
  updatebookreplace: function() {
    ...
    try {
        ...
        var items = ["更新標題和地址", "僅更新地址", "僅更新標題"]; // list items  
        var uselected = {};  
