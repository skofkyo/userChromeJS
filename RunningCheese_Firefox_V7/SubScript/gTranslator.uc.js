...
var gTranslator = {
	...
	onLoad : function () {
		...
		<overlay xmlns="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul" \
			...
			<toolbarpalette id="PanelUI-contents">\
				<toolbarbutton id="gTranslator" label="翻译" type="button" class="toolbarbutton-1" cui-areatype="toolbar" removable="true"\
			...
			<popup id="contentAreaContextMenu">\
				<menuitem id="context-translator" label="翻译选中文本" \
...
image="data:image/png;base64," \
				...
				<menuitem id="context-page-translator" label="翻译当前页面" \
					class="menuitem-iconic" \
image="data:image/png;base64," \
		...
		var css = '\
			#gTranslator {\
				list-style-image: url("data:image/png;base64,");\
	...
	refreshInformation : function (whatToTranslate) {
		if (this.isValidTextLength(whatToTranslate)) {
			...
			var fullUrl = "https://translate.google.com/translate_t?text="+whatToTranslate+"&hl="+cel+"&langpair=auto|"+cel+"&tbb=1" ;
