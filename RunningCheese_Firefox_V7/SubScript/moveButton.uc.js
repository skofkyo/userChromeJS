...
{id: 'lpt_lastpass-compact-btn',bar: "urlbar-icons"},//Laspass按钮
//-------------------文本提示框-----------------------------
{id: "FeiRuoTabplus_UndoBtn",attr: {tooltiptext:"左键：撤销关闭标签\r\n右键：弹出历史列表",}},
...
{id: "identity-box",attr: {tooltiptext:"左键：启动阅读模式\r\n右键：查看页面信息",}},
{id: "bookmarks-menu-button",attr: {buttontooltiptext:"左键：将此页加入书签\r\n右键：打开书签管理器",}},
{id: "urlbar-reload-button",attr: {tooltiptext:"左键：刷新当前页面\r\n右键：强制刷新当前页面",}},
{id: "searchbar-textbox",attr: {tooltiptext:"左键：打开搜索引擎选项\r\n右键：清除搜索框内容",}},
    ];
