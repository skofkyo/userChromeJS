	...
	var downloadPlus = {
		...
		init: function() {
			if (location.href == "chrome://browser/content/browser.xul") {
		      ...
		      tooltiptext:"NewDownLoadPlus",
					image: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAc0lEQVQ4jbWSMQrAIAxFH71HJ6/QrYNzZ++/uvQQdvmB2iIGxQcOhpcfCcJiSk/YZicsCdgbbqteEYAbiLrbDqLqwRNiclTA++7GmspIs5EUkEaajcMrXkDWxN7J8isycDqHnfIrel+2fJyfP/2C6R0M8wCUMi0AHA58MQAAAABJRU5ErkJggg==",
		...
		loadSetting: function(type) {
			...
			if (!type || type === "download_dialog_saveas_dir") {
				// this.PrefStrTrim("download_dialog_saveas_dir", "['C:\\Users\\Administrator\\Desktop\\桌面', '桌面'],['C:\\Users\\Administrator\\Downloads\\下载', '下载'], ['D:\\', 'D盘'],['E:\\', 'E盘'],['F:\\', 'F盘']");
			}
