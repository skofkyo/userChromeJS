...
*/        {    
        ...
            css: "body{width:330px;overflow:hidden;}.m-top,.m-demofm h2{display:none!important}.m-demofm{margin-left:-330px!important;margin-right:-330px!important;margin-top:-75px!important;margin-bottom:-280px!important;}",
            control: {
                play: ".play-pause",
                pause: ".play-pause",
                love: ".f-fr > .j-flag",
  ...
  /*   {
			name: "豆瓣FM（公共版）",
			url: "http://douban.fm/partner/baidu/",
      openLinkInsided: true,
			isWindow: true,
			windowFeatures: 'width=520px,height=260px,resizable',
        },
        {
			name: "豆瓣FM（窗口）",
			url: "http://douban.fm/",
...
/*         {
        ...
        },
       {
            ...
            iframeStyle: "width: 960px; height: 600px;",
            css: "HTML{width:960px;overflow-x:hidden;}#bdshare,.headerbg, #favorite_table_box div[style*='overflow:hidden']{display:none;}",
        },
        {
            name: "萌否电台",
...
*/
        {
            ...
            openLinkInsided: true,
            iframeStyle: "width: 960px; height: 550px;",
            css: "DIV#promotion{ display:none!important; }",
            control: {
                play: ".grobalPlayer",
                pause: ".pauseBtn",
   ...
   {
            name: "音悦台",
            url: "http://www.yinyuetai.com/2345",
            openLinkInsided: true,
            isWindow: true,
            css: ".des,.des_logo,.des_words {display:none!important;}",
            windowFeatures: 'width=652px,height=410px,resizable,scrollbars=yes',
        }, {
            name: "奶酪电台",
            url: "http://www.runningcheese.com/songs",
            openLinkInsided: true,
            iframeStyle: "width: 960px; height: 550px;",
            css: "#nm-wrapper .album--nice {width:160px !important;} .nmplayer-wrap{max-width:860px !important;} .footer-widgets-wrap{display:none !important;}",
            control: {
                playPause: "#nmplayer-button",
                next: ".nm-next fxfont",
                prev: ".nm-previous fxfont",
            },
            state: {
                isPlaying: "return doc.querySelector('#g_player .ply').classList.contains('pas')",
            }
