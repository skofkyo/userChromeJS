	...
	var FeiRuoMouse = {
		...
		loadCustomCommand: function(isAlert) {
			...
			try {
				...
				var ErrMsg = e + "请重新检查选项文件第 " + line + " 行！";
				log(ErrMsg);
