	...
	var FeiRuoTabplus = {
		...
		init: function() {
			...
			ins.parentNode.insertBefore($C("menuitem", {
				...
				label: "标签打开方式",
				tooltiptext: "FeiRuoTabplus\n左键：打开选项窗口\n中键：重载选项文件\n右键：打开选项文件",
				onclick: "FeiRuoTabplus.IconClick(event);",
				image: "data:image/png;base64,",
		...
		UndoBtn: function(isAlert) {
			...
			var UndoBtn = $C("toolbarbutton", {
				...
				removable: "true",
				image: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC",
			});
