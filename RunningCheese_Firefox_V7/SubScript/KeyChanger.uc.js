...
var KeyChanger = {
	...
	createMenuitem : function(){
		...
		menuitem.setAttribute('label', '快捷键自定义');
		menuitem.setAttribute('tooltiptext', 'KeyChanger\n左键：重载配置\n右键：编辑配置');
		...
		menuitem.setAttribute('image', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAgMAAABinRfyAAAACVBMVEUAAAAAAAAAAACDY+nAAAAAAnRSTlMAxOqay5EAAAAiSURBVAjXY0ADUqtWrWRQYGBgYlACAgyW1ioIC0xAFKMCABYYBwHv+ZZuAAAAAElFTkSuQmCC');
