		...
		window.SidebarMod = {
			...
			*/
			...
			AutoClick: function(event) {
			    ...
			    B.addEventListener("click",function(event) {if (event.button == 2) {$("bookmarksShowAll").click();}},false);
			    ...
			    H.addEventListener("click",function(event) {if (event.button == 2) {$("menu_showAllHistory").click();}},false);
			    ...
			    D.addEventListener("click",function(event) {if (event.button == 2) {DownloadsIndicatorView.onCommand(event);}},false);
			    ...
			    A.addEventListener("click",function(event) {if (event.button == 2) {switchToTabHavingURI("about:addons", true);}},false);
			    ...
			    Y.addEventListener("click",function(event) {if (event.button == 2) {openUILinkIn("https://www.youtube.com/", 'tab');}}, false);
			},
