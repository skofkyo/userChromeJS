...
(function () {
		...
		window.SidebarMod = {
			...
			sitelist:[
				...
				},
				{
					...
					favicon: 'data:image/png;base64,',
				},
				{
				...
				/*
				{
					...
					favicon: 'data:image/png;base64,',
					childs: [
						{
							name: 'Bookmarks',
						...
						{
							name: 'Test',
							favicon: 'data:image/png;base64,',
							childs:  [
								{
									name: 'Test1',
									url: '',
			...
			*/
			...
			makeButton: function (sitelist, parent) {
				...
				for (i = 0; i < len; i++) {
					...
					if (item.childs) {
						...
						btn.setAttribute('oncommand',  item.command);
			...
			addControlBtn: function(){
				...
				if(SHBtn) {
					...
					false);
					SHBtn.insertBefore(_sidebarBtn, SHBtn.childNodes[100]);
				}
			},
  ...
  var T = document.querySelector("#translatebutton");
    ...
    B.addEventListener("click",
					function(event) {
						if (event.button == 2) {document.querySelector("#bookmarksShowAll").click();} 
					},
					false);
    ...
    D.addEventListener("click",
					function(event) {
						if (event.button == 2) {DownloadsIndicatorView.onCommand(event);} 
					},
					false);
