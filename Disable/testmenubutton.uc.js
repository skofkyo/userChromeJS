...
(function() {
    ...
    init: {
        ...
        var btn = document.querySelector("#testmenubutton");
    ...
    testmenubutton = {
        mkPanel: function(amenu, parent) {
            ...
            var btnmenupopup = document.createElement("menupopup");
            btnmenupopup.setAttribute("id", "Proxymenupopup");
            btn.appendChild(btnmenupopup);

            for (var i = 0; i < amenu.length; i++) {
                if (amenu[i].label == "sep") {

                } else if (amenu[i].label == "sep") {
                    var menuseparator = document.createElement("menuseparator");
                    btnmenupopup.appendChild(menuseparator);
                } else {
                    ...
                    menuitem.setAttribute('oncommand', amenu[i].command);
                    btnmenupopup.appendChild(menuitem);
                }
            }
        }

    };
    testmenubutton.mkPanel();
})();